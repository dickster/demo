...
public abstract class EasyTabbedPanel2<T extends Serializable> extends Panel implements FeedbackListener, ISection {
    ...
    private static final String TAB_PANEL_INIT = "easy.tabPanel2().init(%s)";
    private static final String SET_STATUS_JS = "document.getElementById('%s').tabPanel.setStatus('%s');";

    private static final JavaScriptHeaderItem TAB_PANEL_JS = JavaScriptReferenceHeaderItem.forReference(new JavaScriptResourceReference(EasyTabbedPanel2.class, "easyTabbedPanel2.js"));
    private static final CssHeaderItem TAB_PANEL_CSS = CssHeaderItem.forReference(new CssResourceReference(EasyTabbedPanel2.class,"easyTabbedPanel.css"));
    ...
    public EasyTabbedPanel2(final String id, final IModel<List<T>> data) {
        super(id);
    ...
    public EasyTabbedPanel2(final String id, final List<T> data) {
    ...
    public EasyTabbedPanel2 withHeader(String header) {
    ...
    public EasyTabbedPanel2<T> setStatus(Enum <?> status) {
        this.status = status;
        return this;
    }
...
//        panelContainer.add(createBlankSlate(BLANK_SLATE_ID));
    ...
    protected void addTab(AjaxRequestTarget target) {
        ...
        target.add(EasyTabbedPanel2.this);
    }
...
// ........
    ...
    public <X extends EasyTabbedPanel2> X allowingOneOrMore() {
        mandatory = true;
        return (X) this;
    }

    public <X extends EasyTabbedPanel2> X allowingZeroOrMore() {
        mandatory = false;
        return (X) this;
    }

    public <X extends EasyTabbedPanel2> X allowingOnlyOne() {
        canAdd = false;
        return (X) this;
    }

    public <T extends EasyTabbedPanel2> T withAddTooltip(String tooltip) {
    ...
    public class AjaxLoadingListener extends AjaxCallListener {
        ...
        public AjaxLoadingListener() {
            ...
            onBefore(String.format(SET_STATUS_JS, EasyTabbedPanel2.this.getMarkupId(),css));
        }
    }
...
//            }
    ...
    public class EasyAdditionTab extends Fragment {
        ...
        private EasyAdditionTab(String id, int index) {
            super(id, "additionTabFragment", EasyTabbedPanel2.this);
...
// for DEBUGGING only....
    ...
    public class EasyTab extends Fragment {
        ...
        public EasyTab(String id, int index) {
            super(id, "tabFragment", EasyTabbedPanel2.this);
