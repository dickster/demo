...
names.peek().endParse();
  ...
  final public void lastName() throws ParseException {
    trace_call("lastName");
    try {getName().setInverse(true);
  ...
  final public void longName() throws ParseException {
    ...
    try {
      ...
      trace_return("longName");
    }
  }

  final public void restOfName() throws ParseException {
    trace_call("restOfName");
    try {
      label_5:
      while (true) {
        name();
...
getCompanyName().add(token.image);
 ...
 {
    if (jj_scan_token(FOURTH)) return true;
    return false;
  }

  private boolean jj_3_44()
 {
    if (jj_scan_token(TM)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(LTD)) return true;
    return false;
  }

  private boolean jj_3R_11()
 {
    if (jj_scan_token(NAME_WITH_NUMBERS)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(ESTATE_OF)) return true;
    return false;
  }
